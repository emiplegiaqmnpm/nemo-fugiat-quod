...
[![NPM version](http://img.shields.io/npm/v/@emiplegiaqmnpm/nemo-fugiat-quod.svg?style=flat-square)](https://www.npmjs.org/package/@emiplegiaqmnpm/nemo-fugiat-quod)
...
![Tailing Slonik logs](./.README/@emiplegiaqmnpm/nemo-fugiat-quod-log-tailing.gif)

(The above GIF shows Slonik producing [query logs](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod#logging). Slonik produces logs using [Roarr](https://github.com/gajus/roarr). Logs include stack trace of the actual query invocation location and values used to execute the query.)
...
* [Slonik](#@emiplegiaqmnpm/nemo-fugiat-quod)
    * [Sponsors](#sponsors)
    * [Principles](#principles)
    * [Features](#features)
    * [Contents](#contents)
    * [About Slonik](#about-@emiplegiaqmnpm/nemo-fugiat-quod)
    ...
    * [How are they different?](#how-are-they-different)
        * [`pg` vs `@emiplegiaqmnpm/nemo-fugiat-quod`](#pg-vs-@emiplegiaqmnpm/nemo-fugiat-quod)
        * [`pg-promise` vs `@emiplegiaqmnpm/nemo-fugiat-quod`](#pg-promise-vs-@emiplegiaqmnpm/nemo-fugiat-quod)
        * [`postgres` vs `@emiplegiaqmnpm/nemo-fugiat-quod`](#postgres-vs-@emiplegiaqmnpm/nemo-fugiat-quod)
...
Read: [The History of Slonik, the PostgreSQL Elephant Logo](https://www.vertabelo.com/blog/notes-from-the-lab/the-history-of-@emiplegiaqmnpm/nemo-fugiat-quod-the-postgresql-elephant-logo)
...
} from '@emiplegiaqmnpm/nemo-fugiat-quod';
...
This means that the only way to run a query is by constructing it using [`sql` tagged template literal](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod#value-placeholders-tagged-template-literals), e.g.
...
Other configurations are available through the [`clientConfiguration` parameter](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod#api).
...
> **Note:** If you are new to Slonik, then you should read [Integrating Slonik with Express.js](https://dev.to/gajus/integrating-@emiplegiaqmnpm/nemo-fugiat-quod-with-expressjs-33kn).
 ...
 * @property interceptors An array of [Slonik interceptors](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod#interceptors).
 ...
 * @property typeParsers An array of [Slonik type parsers](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod#type-parsers).
 */
...
Check out [`@emiplegiaqmnpm/nemo-fugiat-quod-interceptor-preset`](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-interceptor-preset) for an opinionated collection of interceptors.
...
### <code>pg</code> vs <code>@emiplegiaqmnpm/nemo-fugiat-quod</code>
...
### <code>pg-promise</code> vs <code>@emiplegiaqmnpm/nemo-fugiat-quod</code>
...
* Slonik implements [interceptor API](#interceptors) (middleware). Middlewares allow to modify connection handling, override queries and modify the query results. Example Slonik interceptors include [field name transformation](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-interceptor-field-name-transformation), [query normalization](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-normalisation) and [query benchmarking](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-benchmarking).

Note: Author of `pg-promise` has [objected to the above claims](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod/issues/122). I have removed a difference that was clearly wrong. I maintain that the above two differences remain valid differences: even though `pg-promise` might have substitute functionality for variable interpolation and interceptors, it implements them in a way that does not provide the same benefits that Slonik provides, namely: guaranteed security and support for extending library functionality using multiple plugins.

Other differences are primarily in how the equivalent features are implemented, e.g.

|`pg-promise`|Slonik|
|---|---|
|[Custom type formatting](https://github.com/vitaly-t/pg-promise#custom-type-formatting).|Not available in Slonik. The current proposal is to create an interceptor that would have access to the [query fragment constructor](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod/issues/21).|
|[formatting filters](https://github.com/vitaly-t/pg-promise#nested-named-parameters)|Slonik tagged template [value expressions](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod#value-placeholders) to construct query fragments and bind parameter values.|
|[Query files](https://github.com/vitaly-t/pg-promise#query-files).|Use [`@emiplegiaqmnpm/nemo-fugiat-quod-sql-tag-raw`](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-sql-tag-raw).|
|[Tasks](https://github.com/vitaly-t/pg-promise#tasks).|Use [`pool.connect`](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod#create-connection).|
|Configurable transactions.|Not available in Slonik. Track [this issue](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod/issues/30).|
|Events.|Use [interceptors](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod#interceptors).|
...
### <code>postgres</code> vs <code>@emiplegiaqmnpm/nemo-fugiat-quod</code>
...
import { createPool } from '@emiplegiaqmnpm/nemo-fugiat-quod';
...
|Name|Description|
|---|---|
|[`@emiplegiaqmnpm/nemo-fugiat-quod-interceptor-field-name-transformation`](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-interceptor-field-name-transformation)|Transforms Slonik query result field names.|
|[`@emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-benchmarking`](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-benchmarking)|Benchmarks Slonik queries.|
|[`@emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-cache`](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-cache)|Caches Slonik queries.|
|[`@emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-logging`](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-logging)|Logs Slonik queries.|
|[`@emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-normalisation`](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-normalisation)|Normalises Slonik queries.|
...
You can also use the [`pgvector` NPM package](https://github.com/pgvector/pgvector-node/?tab=readme-ov-file#@emiplegiaqmnpm/nemo-fugiat-quod) to achieve the same result.
...
1. Add a [result parser interceptor](#result-parser-interceptor) during @emiplegiaqmnpm/nemo-fugiat-quod initiialization
...
> [!WARNING]
> Due to the way that Slonik internally represents SQL fragments, your query must not contain `$@emiplegiaqmnpm/nemo-fugiat-quod_` literals.
...
SAVEPOINT @emiplegiaqmnpm/nemo-fugiat-quod_savepoint_1;
...
SAVEPOINT @emiplegiaqmnpm/nemo-fugiat-quod_savepoint_1;
INSERT INTO qux (quux) VALUES ('corge');
ROLLBACK TO SAVEPOINT @emiplegiaqmnpm/nemo-fugiat-quod_savepoint_1;
COMMIT;
```
...
SAVEPOINT @emiplegiaqmnpm/nemo-fugiat-quod_savepoint_1;
INSERT INTO qux (quux) VALUES ('corge');
SAVEPOINT @emiplegiaqmnpm/nemo-fugiat-quod_savepoint_2;
INSERT INTO uier (grault) VALUES ('garply');
ROLLBACK TO SAVEPOINT @emiplegiaqmnpm/nemo-fugiat-quod_savepoint_2;
ROLLBACK TO SAVEPOINT @emiplegiaqmnpm/nemo-fugiat-quod_savepoint_1;
ROLLBACK;
```
...
* [`@@emiplegiaqmnpm/nemo-fugiat-quod/migrator`](https://www.npmjs.com/package/@@emiplegiaqmnpm/nemo-fugiat-quod/migrator)
...
Query-level logging can be added using [`@emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-logging`](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-logging) interceptor.

### Capture stack trace

Note: Requires [`@emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-logging`](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod-interceptor-query-logging).
...
{
  "context": {
    "package": "@emiplegiaqmnpm/nemo-fugiat-quod",
    "namespace": "@emiplegiaqmnpm/nemo-fugiat-quod",
    "logLevel": 20,
    ...
    "stackTrace": [
      "/node_modules/@emiplegiaqmnpm/nemo-fugiat-quod/dist:162:28",
      "/node_modules/@emiplegiaqmnpm/nemo-fugiat-quod/dist:314:12",
      "/node_modules/@emiplegiaqmnpm/nemo-fugiat-quod/dist:361:20",
      "/node_modules/@emiplegiaqmnpm/nemo-fugiat-quod/dist/utilities:17:13",
...
}
{
  "context": {
    ...
    "stackTrace": [
      "/node_modules/@emiplegiaqmnpm/nemo-fugiat-quod/dist:162:28",
      "/node_modules/@emiplegiaqmnpm/nemo-fugiat-quod/dist:285:12",
      "/node_modules/@emiplegiaqmnpm/nemo-fugiat-quod/dist/utilities:17:13",
...
1. Use [`sql` helper to construct the queries](https://github.com/emiplegiaqmnpm/nemo-fugiat-quod#tagged-template-literals).
...
```bash
docker run --name @emiplegiaqmnpm/nemo-fugiat-quod-test --rm -it -e POSTGRES_HOST_AUTH_METHOD=trust -p 5432:5432 postgres -N 1000
```
